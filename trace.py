...
from pywolfgame import * # Change this to import everything from the file containing main().

TRACE_BASE = "/Users/tejassharma/Programming/Python/pywolfgame.py" # Change this to the file you want to trace.
